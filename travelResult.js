...
const icons = {
    "Spice Jet" : "https://static.tacdn.com/img2/flights/airlines/logos/100x100/Spicejet.png",
    "Go Air" : "https://static.tacdn.com/img2/flights/airlines/logos/100x100/GoAir.png",
    "Indi Go" : "https://static.tacdn.com/img2/flights/airlines/logos/100x100/IndiGoAirlines.png",
    "Air India" : "https://static.tacdn.com/img2/flights/airlines/logos/100x100/AirIndia.png",
    "Air Asia" : "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/AirAsia_New_Logo.svg/768px-AirAsia_New_Logo.svg.png",
    Vistara : "https://static.tacdn.com/img2/flights/airlines/logos/100x100/Vistara.png"
}
    ...
    if(search.type==="roundTrip"){
        ...
        data1.forEach((element,index) => {
            data2.forEach((element2,index2)=>{
                ...
                const h21 = document.createElement("h2")
                h21.innerText = `Rs.${calculatePrice(element2,search.from,search.to,index2)+calculatePrice(element,search.from,search.to,index)}`
        ...
        data1.forEach((element,index)=>{
            ...
            const h2 = document.createElement("h2")
            h2.innerText = `Rs.${calculatePrice(element,search.from,search.to,index)}`
...
function calculatePrice(element,from,to,index){
    let sum = asciValue[from.toLowerCase()]+asciValue[to.toLowerCase()]+asciValue[element.company]
    const stopVal = index<18?asciValue["nonstop"]:index<36?asciValue["onestop"]*1.5:asciValue["oneplusstop"]*2
    sum += stopVal 
    // console.log(sum,ret)
    // console.log()
    return sum
